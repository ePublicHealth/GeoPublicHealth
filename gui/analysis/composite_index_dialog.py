...
from GeoPublicHealth.ui.analysis.composite_index import Ui_Composite_Index
...
class CommonCompositeIndexDialog(QDialog):
    ...
    def run_stats(self):
        ...
        if self.use_point_layer:
            ...
            case_column = self.cbx_indicator_field.currentField()
...
class CompositeIndexDialog(CommonCompositeIndexDialog, Ui_Composite_Index):
    def __init__(self, parent=None):
        """Constructor."""
