...
class KmlExport(QWidget, FORM_CLASS):
    ...
    def __init__(self, parent=None):
        ...
        self.buttonBox.button(QDialogButtonBox.Save).clicked.connect(self.save_kml)
    ...
    def open_file_browser(self):
        ...
        output_file, __ = get_save_file_path(
            parent=self.parent,
            title=tr("Export as KML"),
            directory="",
            file_filter="KML (*.kml)",
            prompt=tr("Output file path (.kml):"),
        )
    ...
    def save_kml(self):
        ...
        QgsVectorFileWriter.writeAsVectorFormat(layer, path, "utf-8", None, "kml")
